...
class DerivedDateTimeTest {
    ...
    public static void testPopularBirthdays() {
        ...
        LocalDate vDayBirth = vDay.plusWeeks(38);

        System.out.println(vDayBirth);
        ...
        LocalDate nydBirth = newYearsDay.plusWeeks(38);
        System.out.println(nydBirth);
    }
    ...
    public static void testEarlyRetirement() {
        ...
        LocalDate bday = LocalDate.of(1962, 10, 02);
    ...
    public static void testLaborDay() {
        ...
        LocalDate sep1 = LocalDate.of(1962, 8, 01);
