...
public class Television {
    ...
    public void mute() throws InvalidVolumeException {
...
//            throw new IllegalArgumentException("For your " + brand + " TV, the volume must be from " + MIN_VOLUME +
//                    " to " + MAX_VOLUME + ". " + " You entered: " + volume + ", setting volume to 0");
            }
    }
